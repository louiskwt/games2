...
def main():
    ...
    pygame.display.set_caption('Spacecraft3')

    sprite_sheet_image = pygame.image.load('spacecraft3.png').convert_alpha()
    ...
    while run:
        ...
        if current_time - last_update >= animation_cooldown:
            ...
            if nhits == 10:
                # time.sleep(3)
                run = False
                txt = "Game is over! Hits: " + str(nhits) + "; Time: " + str(round((current_time - t0)/1000.,1)) + "s"
